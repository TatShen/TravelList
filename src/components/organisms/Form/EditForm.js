   ...
   console.log(this.state.user);
    ...
    return `
        <form>
          ...
          <input placeholder="Введите имя" class="input firstname" type="text" name="firstname" value="${this.state.user.length ? 'Введите имя' : this.state.user.firstname }">
          <input placeholder="Введите фамилию" class="input lastname" type="text" name="lastname" value="${this.state.user.length ? 'Введите фамилию' : this.state.user.lastname }">
          <input placeholder="Введите страну проживания" class="input country" type="text" name="country" value="${this.state.user.length ? 'Введите страну проживания' : this.state.user.country }">
          <input placeholder="Введите страну проживания" class="input " type="text" name="uid" value="${this.state.uid}" hidden>
          <input placeholder="Введите информацию о себе" class="textarea country" type="text" name="description" value="${this.state.user.length ? 'Введите информацию о себе' : this.state.user.description}"></input>
