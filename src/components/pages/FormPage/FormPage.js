...
export class FormPage extends Component {
  ...
  render() {
    return `
        ...
        <tl-button content="Войти" classname="form" type="button" class="${
          this.state.isNewUser ? "" : "activ"
        } type="button" eventtype="change-form" ></tl-button>
        <tl-button content="Регистрация" classname="form" class="${
          this.state.isNewUser ? "activ" : ""
        }"  eventtype="change-form"></tl-button>
      </div>
